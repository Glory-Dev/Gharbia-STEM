...
function generateCards(container, managementCommittee) {
  ...
  managementCommittee.forEach((member) => {
    const col = document.createElement("div");
    col.className = "col";

    const card = document.createElement("div");
    card.className = "card mb-3 bg-transparent";
    ...
    cardBody.className = "card-body show-left rounded-4 secondary-bg text-white";
    ...
    phoneText.className = "card-text fs-4 mt-3";
